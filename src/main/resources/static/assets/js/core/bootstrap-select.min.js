        ...
        k.VERSION = "1.12.2", k.DEFAULTS = {
            ...
            constructor: k, init: function () {
                ...
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    j = '<div class="btn-group bootstrap-select' + b + c + '"><button type="button" class="' + this.options.styleBase + ' " ' + d + ' role="button"><span class="filter-option pull-left"></span>&nbsp;' + this.options.template.caret + '</button><div class="dropdown-menu open" role="combobox">' + e + f + g + '<ul class="dropdown-menu inner" role="listbox" aria-expanded="false"></ul>' + h + "</div></div>";
                return a(j)
            }, createView: function () {
