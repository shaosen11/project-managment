...
public class DocumentsController {
    ...
    @Autowired
    ProjectServiceImpl projectsService;
    @Autowired
    ProjectsPackageServiceImpl projectsPackageService;
...
//        Documents d2 = new Documents();
        ...
        //判断是否为项目组长
        Integer power = 0;
        if (projectsService.getAdminByUserIdAndProjectId(userid, projectId) != null) {
            power = 1;
        } else {
            power = null;
        }
